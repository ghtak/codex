...
template <>
struct make_index_sequence0<0> {
    using type = index_sequence<>;
};

template <>
struct make_index_sequence0<1> {
...
template <std::size_t I, template <typename...> class T, typename Head,
          typename... Ts>
...
template <std::size_t I, template <typename...> class T, typename Type,
          typename... Ts, typename... Us>
struct _remove_at<I, T<Ts...>, T<Type, Us...>> {
    using type = typename _remove_at<I - 1, T<Ts..., Type>, T<Us...>>::type;
};

template <template <typename...> class T, typename Type, typename... Ts,
          typename... Us>
